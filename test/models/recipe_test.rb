...
class RecipeTest < ActiveSupport::TestCase
  ...
  def setup
    ...
    @recipe = @chef.recipes.build(name: "Chicken Parm", summary: "Best chicken parm recipe ever", description: "Heat oil, add onions,          add tomato sauce, add chicken, cook for 25 minutes")
  end
